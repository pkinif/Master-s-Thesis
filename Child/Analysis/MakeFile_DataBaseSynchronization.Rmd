...
test <- plm(Roic ~ CarbonProductivity + WasteProductivity + WaterProductivity + SustainabilityPayLink + SustainableThemedCommitment + AuditScore + NetMargin + log(TotalAssets) + DebtToEquityRatio + Beta + GicsClassification , index = c("CompaniesIndex", "YearIndex"), data = Lag1C, model = "random")   
