...
ABBV <- FinalCapm4[FinalCapm4$Ticker == "ABBV",]
ABBV1 <- ABBV[1:3,]

FinalCapm5 <- FinalCapm4[!FinalCapm4$Ticker == "ABBV",]
FinalCapm6 <- as.data.frame(rbind(FinalCapm5, ABBV1))

write.csv2(FinalCapm6, file = "DataBase/Lag1_WithCapm.csv")
