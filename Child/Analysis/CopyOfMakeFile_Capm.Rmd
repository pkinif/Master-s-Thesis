...
CAPM2 <- read.csv2(file = "DataBase/StockPrice/CAPM.csv", header = TRUE, stringsAsFactors = FALSE, sep = ",")
...
CAPM3 <- merge(Companies, CAPM2, by = "Ticker", all = TRUE)
CAPM4 <- CAPM3[,c(1,2,10:18)] 
...
CAPM5 <- merge(Lag1A, CAPM4, by = c("Companies", "Year"), all= TRUE)
CAPM5[,c()]

#I reduce the number to the most important variables


write.csv2(CAPM5, file = "DataBase/Lag1_WithCapm_WithNA.csv")
