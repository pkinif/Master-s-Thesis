...
#Database
DB_Lag0<-as.data.frame(read.csv2("DataBase/Lag_0.csv", sep = ";",stringsAsFactors=FALSE, header = TRUE ))
...
Roa <-lm(ROA ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + Leverage + NetMargin + FirmSize + Industry, data = DB_Lag0)

TobinsQ<-lm(TobinsQ ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + Leverage + NetMargin + FirmSize + Industry, data = DB_Lag0)

Roe <- lm(TobinsQ ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + Leverage + NetMargin + FirmSize + Industry, data = DB_Lag0)
...
head(DB_Lag0[influentialRoa, ])  # influential observations - number = 2 
head(DB_Lag0[influentialTobin, ])  # influential observations - number = 40
head(DB_Lag0[influentialRoe, ])  # influential observations - number = 38


#I remove outliers and create three new data frames

DB_Lag0_NoOutliers <- DB_Lag0[-c(influentialTobin,influentialRoa),]
...
#Model with outliers
Roa1<-plm(ROA ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + Leverage + NetMargin + FirmSize + Industry, data = DB_Lag0, index = c("Companies", "YearFinancialIndicator"), model = "random") 

#Model without the 2 outliers from ROA
Roa2 <-plm(ROA ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + Leverage + NetMargin + FirmSize + Industry , data = DB_Roa_NoOut, index = c("Companies", "YearFinancialIndicator"), model = "random") 

#Model without the 42 outliers from both Tobin's Q and ROA
Roa3 <-plm(ROA ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + Leverage + NetMargin + FirmSize + Industry, data = DB_Lag0_NoOutliers, index = c("Companies", "YearFinancialIndicator"), model = "random") 
...
#Mode2 with outliers
Tobins1 <- plm(TobinsQ ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + Leverage + NetMargin + FirmSize + Industry, data = DB_Lag0, index = c("Companies", "YearFinancialIndicator"), model = "random")

#Mode2 without the 40 outliers from Tobin's Q
Tobins3 <-plm(TobinsQ ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore +  CarbonProductivity + WaterProductivity + WasteProductivity + Leverage + NetMargin + FirmSize + Industry, data = DB_Lag0_NoOutliers, index = c("Companies", "YearFinancialIndicator"), model = "random")
...
#Mode3 with outliers
Roe1<-plm(ROE ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + Leverage + NetMargin + FirmSize + Industry, data = DB_Lag0, index = c("Companies", "YearFinancialIndicator"), model = "random") 
