...
#Summary in a table    
  ...
  PlmTable <- as.data.frame(rbind(PlmtestTobinsQ, PlmtestRoa, PlmtestRoe, PlmtestRoic, PlmtestRa, PlmtestPriceToEarningRatio))
...
#Summary in a table    
  ...
  pFtestTable <- as.data.frame(rbind(pFtestTobinsQ, pFtestRoa, pFtestRoe, pFtestRoic, pFtestRa, pFtestPriceToEarningRatio))
...
#Summary in a table    
  ...
  phtestTable <- as.data.frame(rbind(phtestTobinsQ, phtestRoa, phtestRoe, phtestRoic, phtestRa, phtestPriceToEarningRatio))
...
Roic_Db <- Model[-c(influentialRoic),]
write.csv(Roe_Db, file = "DataBase/DataSynchronization/NoOutliersLag1/GreenScore/Roic.csv")
