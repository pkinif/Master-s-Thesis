...
Roa <-lm(Roa ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta , data = Model)

TobinsQ<-lm(log(TobinsQ) ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta , data = Model)

Roe <- lm(Roe ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta , data = Model)

Roic <- lm(Roic ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta , data = Model)

Ra <- lm(Ra ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta , data = Model)

AlphaJensen <- lm(AlphaJensen ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta , data = Model)
...
write.csv(Roa_Db, file = "DataBase/DataSynchronization/NoOutliersLag1/Roa.csv")

Roe_Db <- Model[-c(influentialRoe),]
write.csv(Roe_Db, file = "DataBase/DataSynchronization/NoOutliersLag1/Roe.csv")
...
write.csv(AlphaJensen_Db, file = "DataBase/DataSynchronization/NoOutliersLag1/AlphaJensen.csv")
```
...
#TobinsQ
  PoolTobinsQ<- plm(LogTobinsQ ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = TobinsQ_Db, model="pooling", index = c("CompaniesIndex","YearIndex"))
...
#Roa
  PoolRoa <- plm(Roa ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roa_Db, model="pooling", index = c("CompaniesIndex","YearIndex"))
...
#Roe
  PoolRoe<- plm(Roe ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roe_Db, model="pooling", index = c("CompaniesIndex","YearIndex"))
...
#Roic
  PoolRoic <- plm(Roic ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roic_Db, model="pooling", index = c("CompaniesIndex","YearIndex"))
...
#Ra
  PoolRa <- plm(Ra ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Ra_Db, model="pooling", index = c("CompaniesIndex","YearIndex"))
...
#AlphaJensen
  PoolAlphaJensen <- plm(AlphaJensen ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = AlphaJensen_Db, model="pooling", index = c("CompaniesIndex","YearIndex"))
...
#######################################################
  ...
  FixedTobinsQ<- plm(LogTobinsQ ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = TobinsQ_Db, model="within", index = c("CompaniesIndex","YearIndex"), effect = "time")
  
  FixedRoa<- plm(Roa ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roa_Db, model="within", index = c("CompaniesIndex","YearIndex"), effect = "time")

  FixedRoe<- plm(Roe ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roe_Db, model="within", index = c("CompaniesIndex","YearIndex"), effect = "time")

  FixedRoic <- plm(Roic ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roic_Db, model="within", index = c("CompaniesIndex","YearIndex"), effect = "time")
  
  FixedRa <- plm(Ra ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Ra_Db, model="within", index = c("CompaniesIndex","YearIndex"), effect = "time")


  FixedAlphaJensen <- plm(AlphaJensen ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = AlphaJensen_Db, model="within", index = c("CompaniesIndex","YearIndex"), effect = "time")
  
  # Individual Effect
  ###################
  
  FixedTobinsQ1 <- plm(LogTobinsQ ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = TobinsQ_Db, model="within", index = c("CompaniesIndex","YearIndex"), effect = "individual")
  
  FixedRoa1 <- plm(Roa ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roa_Db, model="within", index = c("CompaniesIndex","YearIndex"), effect = "individual")

  FixedRoe1 <- plm(Roe ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roe_Db, model="within", index = c("CompaniesIndex","YearIndex"), effect = "individual")

  FixedRoic1 <- plm(Roic ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roic_Db, model="within", index = c("CompaniesIndex","YearIndex"), effect = "individual")
  
  FixedRa1 <- plm(Ra ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Ra_Db, model="within", index = c("CompaniesIndex","YearIndex"), effect = "individual")

  FixedAlphaJensen1 <- plm(AlphaJensen ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = AlphaJensen_Db, model="within", index = c("CompaniesIndex","YearIndex"), effect = "individual")
  
  # TwoWays Effect
  ###################
  
  FixedTobinsQ2 <- plm(LogTobinsQ ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = TobinsQ_Db, model="within", index = c("CompaniesIndex","YearIndex"), effect = "twoways")
  
  FixedRoa2 <- plm(Roa ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roa_Db, model="within", index = c("CompaniesIndex","YearIndex"), effect = "twoways")

  FixedRoe2 <- plm(Roe ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roe_Db, model="within", index = c("CompaniesIndex","YearIndex"), effect = "twoways")

  FixedRoic2 <- plm(Roic ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roic_Db, model="within", index = c("CompaniesIndex","YearIndex"), effect = "twoways")
  
  FixedRa2 <- plm(Ra ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Ra_Db, model="within", index = c("CompaniesIndex","YearIndex"), effect = "twoways")

  FixedAlphaJensen2 <- plm(AlphaJensen ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = AlphaJensen_Db, model="within", index = c("CompaniesIndex","YearIndex"), effect = "twoways")
...
#######################################################
  ...
  RandomTobinsQ<- plm(LogTobinsQ ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = TobinsQ_Db, model="random", index = c("CompaniesIndex","YearIndex"))
  
  RandomRoa<- plm(Roa ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roa_Db, model="random", index = c("CompaniesIndex","YearIndex"))

  RandomRoe<- plm(Roe ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roe_Db, model="random", index = c("CompaniesIndex","YearIndex"))

  RandomRoic <- plm(Roic ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roic_Db, model="random", index = c("CompaniesIndex","YearIndex"))

  RandomRa <- plm(Ra ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Ra_Db, model="random", index = c("CompaniesIndex","YearIndex"))
  
  RandomAlphaJensen <- plm(AlphaJensen ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = AlphaJensen_Db, model="random", index = c("CompaniesIndex","YearIndex"))
...
#znp <- pvcm(Roa ~ GreenScore + FirmSize + Beta, data = Model1, model="within", index = c("Index","YearIndex"))

#zplm <- plm(Roa ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Model1, model="within", index = c("Index","YearIndex"))

#PoolTestRoa <- pooltest(zplm,znp)



#PoolTestRoa <- pooltest(Roa ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta , data = Model1, model = "within")
