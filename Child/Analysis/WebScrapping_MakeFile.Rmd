...
Results_List <- lapply(Ticker, possibly(function(x) {
  ...
  getdata <- function(link){
      ...
      data1 <- html_text(data)#converting the data to text
...
Results7 <- unite(Results6, "Date", c("Day", "month_num", "Year"), sep = "-")

#Remove all spaces
Results7$Date <-  str_trim(Results7$Date)
```
