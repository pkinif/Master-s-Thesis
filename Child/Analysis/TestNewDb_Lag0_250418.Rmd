...
Roa4 <-plm(Roa ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + log(TotalAssets) + NetMargin + Beta + DebtToEquityRatio + AlphaJensen  + GicsClassification   , data = DB_Roa_NoOut, index = c("Index", "Year"), model = "random") 
