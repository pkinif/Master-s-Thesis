...
# Issues with panel data to considerate

From @Delmas2015

> Panel data include observations on N cross section units (i.e., firms) over T time-periods. As panel data analysis uses variation in both these dimensions, it is considered to be one of the most efficient analytical methods for data (Asteriou, 2006).
