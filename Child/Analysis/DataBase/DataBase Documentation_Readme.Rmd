...
This document give you an overview of my database. The table \ref{Smpl} contains a sample of my database. The table \ref{VarDef} desribes my variables. 

You can notice that there are some missing values in the 
