...
filled_form<-set_values(pgform, username ="pierrick.kinif.001@student.uni.lu", password="Olaf1234")
...
Results_List <- lapply(Ticker, possibly(function(x) {
  ...
  #go to the page
  link <- paste("https://ycharts.com/companies/", x, "/return_on_invested_capital", sep = "")
