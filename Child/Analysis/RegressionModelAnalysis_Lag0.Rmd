...
#TobinsQ
  PoolTobinsQ<- plm(LogTobinsQ ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = TobinsQ_Db, model="pooling", index = c("Index","Year"))
...
#Roa
  PoolRoa <- plm(Roa ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roa_Db, model="pooling", index = c("Index","Year"))
...
#Roe
  PoolRoe<- plm(Roe ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roe_Db, model="pooling", index = c("Index","Year"))
...
#Roic
  PoolRoic <- plm(Roic ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roic_Db, model="pooling", index = c("Index","Year"))
...
#Ra
  PoolRa <- plm(Ra ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Ra_Db, model="pooling", index = c("Index","Year"))
...
#AlphaJensen
  PoolAlphaJensen <- plm(AlphaJensen ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = AlphaJensen_Db, model="pooling", index = c("Index","Year"))
...
#######################################################
  ...
  FixedTobinsQ<- plm(LogTobinsQ ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = TobinsQ_Db, model="within", index = c("Index","Year"), effect = "time")
  
  FixedRoa<- plm(Roa ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roa_Db, model="within", index = c("Index","Year"), effect = "time")

  FixedRoe<- plm(Roe ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roe_Db, model="within", index = c("Index","Year"), effect = "time")

  FixedRoic <- plm(Roic ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roic_Db, model="within", index = c("Index","Year"), effect = "time")
  
  FixedRa <- plm(Ra ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Ra_Db, model="within", index = c("Index","Year"), effect = "time")


  FixedAlphaJensen <- plm(AlphaJensen ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = AlphaJensen_Db, model="within", index = c("Index","Year"), effect = "time")
  
  # Individual Effect
  ###################
  
  FixedTobinsQ1 <- plm(LogTobinsQ ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = TobinsQ_Db, model="within", index = c("Index","Year"), effect = "individual")
  
  FixedRoa1 <- plm(Roa ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roa_Db, model="within", index = c("Index","Year"), effect = "individual")

  FixedRoe1 <- plm(Roe ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roe_Db, model="within", index = c("Index","Year"), effect = "individual")

  FixedRoic1 <- plm(Roic ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roic_Db, model="within", index = c("Index","Year"), effect = "individual")
  
  FixedRa1 <- plm(Ra ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Ra_Db, model="within", index = c("Index","Year"), effect = "individual")

  FixedAlphaJensen1 <- plm(AlphaJensen ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = AlphaJensen_Db, model="within", index = c("Index","Year"), effect = "individual")
  
  # TwoWays Effect
  ###################
  
  FixedTobinsQ2 <- plm(LogTobinsQ ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = TobinsQ_Db, model="within", index = c("Index","Year"), effect = "twoways")
  
  FixedRoa2 <- plm(Roa ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roa_Db, model="within", index = c("Index","Year"), effect = "twoways")

  FixedRoe2 <- plm(Roe ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roe_Db, model="within", index = c("Index","Year"), effect = "twoways")

  FixedRoic2 <- plm(Roic ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roic_Db, model="within", index = c("Index","Year"), effect = "twoways")
  
  FixedRa2 <- plm(Ra ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Ra_Db, model="within", index = c("Index","Year"), effect = "twoways")

  FixedAlphaJensen2 <- plm(AlphaJensen ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = AlphaJensen_Db, model="within", index = c("Index","Year"), effect = "twoways")
...
#######################################################
  ...
  RandomTobinsQ<- plm(LogTobinsQ ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = TobinsQ_Db, model="random", index = c("Index","Year"))
  
  RandomRoa<- plm(Roa ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roa_Db, model="random", index = c("Index","Year"))

  RandomRoe<- plm(Roe ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roe_Db, model="random", index = c("Index","Year"))

  RandomRoic <- plm(Roic ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Roic_Db, model="random", index = c("Index","Year"))

  RandomRa <- plm(Ra ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Ra_Db, model="random", index = c("Index","Year"))
  
  RandomAlphaJensen <- plm(AlphaJensen ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = AlphaJensen_Db, model="random", index = c("Index","Year"))
...
#znp <- pvcm(Roa ~ GreenScore + FirmSize + Beta, data = Model1, model="within", index = c("Index","Year"))

#zplm <- plm(Roa ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore + CarbonProductivity + WaterProductivity + WasteProductivity + FirmSize + NetMargin + Leverage + Industry + Beta, data = Model1, model="within", index = c("Index","Year"))
