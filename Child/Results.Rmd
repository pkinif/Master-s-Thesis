...
\autoref{Lag1} reports the main results of the analysis of the impact of both process-based CEP (i.e. SPL, STC and A) and outcome-based CEP (i.e. CaP, WatP and WastP) on short-term CFP (ROA) and long-term CFP (i.e. TobinsQ). Based on the pvalue of BPLM and F tests, model (4) had been estimated with the *pooled OLS estimation* while model (5) had been estimated with the *fixed effects estimation*. 
