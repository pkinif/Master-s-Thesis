...
Model (4) shows evidence of a positive and statistically significant effect of sustainability pay link, audit score, and water productivity on *long-term CEP*. Model (5) shows evidence of a positive and statistically significant effect of sustainability pay link, sustainable themed commitment and carbon productivity on *short-term CEP*.

More precisely, regarding process-based CEP variables, results show that companies, which link the remuneration of any member of a company’s senior executive team with the achievement of environmental performance targets, are caractherized by both a higher Tobin's Q (i.e. +0.079) and ROA (i.e. +0.008). Then, the fact of having a sustainability committee at the board of directors level increases the ROA by 0.012. Finally, companies having their latest reported environmental metrics audited by a third party have a higher Tobin's Q (i.e. + 0.158). Regarding outcome-based CEP variables, results demonstrate that a 1% increase of carbon productivity increases the ROA by 0.03 and a 1% increase of Water productivity increases the Tobin's Q by 0.337.

These results corroborate recent meta-analyses that claim positive influence between CEP and CFP [@Orlitzky2003; @Wu2006; @Albertini2013; @Dixon-Fowler2013; @EndrikatMakingsenseconflicting2014; @Ludecadedebatenexus2014; @WangMetaAnalyticReviewCorporate2016; @Busch2018]. Furthermore, it provide evidence that the relationship is always positive, no matter the time horizon, and stronger with a long-term than a short-term perspective. Hence, results also support the general consensus that accounting-based measures are characterized by a stronger relation to CEP than market-based indicators [@Orlitzky2003; @Wu2006; @Albertini2013; @Ludecadedebatenexus2014; @Busch2018]. Hypothesis 2, 3, 4 and 5 are verified.
