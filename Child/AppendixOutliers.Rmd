...
Tobins3 <-plm(TobinsQ ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore +  CarbonProductivity + WaterProductivity + WasteProductivity + Leverage + NetMargin + FirmSize + Industry, data = DB_TobinsQ_NoOut, index = c("Companies", "YearFinancialIndicator"), model = "random")
...
#Mode2 without the 40 outliers from Tobin's Q
Tobins3_Fixed <-plm(TobinsQ ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore +  CarbonProductivity + WaterProductivity + WasteProductivity + Leverage + NetMargin + FirmSize + Industry, data = DB_TobinsQ_NoOut, index = c("Companies", "YearFinancialIndicator"), model = "within")
...
#Mode2 without the 40 outliers from Tobin's Q
Tobins3_Pooling <-plm(TobinsQ ~ SustainabilityPayLink + SustainableThemedCommitment + AuditScore +  CarbonProductivity + WaterProductivity + WasteProductivity + Leverage + NetMargin + FirmSize + Industry, data = DB_TobinsQ_NoOut, index = c("Companies", "YearFinancialIndicator"), model = "pooling")
