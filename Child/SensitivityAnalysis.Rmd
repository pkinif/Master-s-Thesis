...
R script of this section is in the [Appendix D : Sensitivity Analysis - R script].
...
stargazer(TobinPooling, RoaPooling, title = "The impact of process and outcome-based CEP on CFP (lag = 2)", label = "Lag2", header = FALSE, type = "latex", align = FALSE, model.numbers = FALSE, table.placement = "!", add.lines = list(c("BPLM test (pvalue)", PlmtestTobin, PlmtestRoa),
