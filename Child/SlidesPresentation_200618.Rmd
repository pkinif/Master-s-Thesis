...
- Companies are important stakeholders of Global Warming. They are part of the **problem** but can be part of the **solution**
...
Inclusion of a vector of control variables \(Controls_{it}\) that explain the relation between CEP and CFP

### Simultaneity bias

\scriptsize

There is a bidirectional causality between CEP and CFP [@EndrikatMakingsenseconflicting2014] that could cause  simultaneous causality. I used a lagged instrument \(Y_{it+1}\) to increases the confidence of the direction of the relationship [@MiroshnychenkoGreenpracticesfinancial2017]
