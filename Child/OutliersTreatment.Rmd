...
This appendix presents the R code I have used to identify and remove outliers from my database. 
...
# Database Loading 
Lag1 <- read.csv(
  file = "Analysis/DataBase/DataSynchronization/Lag1.csv", 
  header = TRUE, 
...
# I extract rows considered as influential (i.e. observations whose D > 4 * means)
...
write.csv(
  TobinsQ_Db,
  file = "Analysis/DataBase/DataSynchronization/NoOutliersLag1/TobinsQ.csv")

Roa_Db <- ModelLag1[-c(influentialRoa),]
write.csv(
  Roa_Db, 
  file = "Analysis/DataBase/DataSynchronization/NoOutliersLag1/Roa.csv")
