The following R script is the R code used to produce the section : [Results].
...
DataBase <- read.csv(file = path, header = TRUE, stringsAsFactors = FALSE)
...
IdenticalAnalyses <- round(t.test(
  Sample1, 
  Sample2, 
...
CorMatrix <- corstars(Model2, 
                      ...
                      result = "none")
# Right now, names of each variable stand as row names and column names. 
...
# VIF Calculation summary in a nice stargazer table
...
stargazer(CarbonWithin, 
          ...
          WasteWithin, 
          title = 
            "The impact of process-based on outcome-based CEP", 
          label = "CepResults", 
          header = FALSE, 
          type = "latex", 
          align = FALSE, 
...
path <- "Analysis/DataBase/DataSynchronization/NoOutliersLag1/Roa.csv"
RoaNoOut <- read.csv(file = path, header = TRUE, stringsAsFactors = FALSE)
path <- "Analysis/DataBase/DataSynchronization/NoOutliersLag1/TobinsQ.csv"
...
stargazer(TobinPooling, 
          RoaWithin, 
          title = 
            "The impact of process and outcome-based CEP on CFP (lag = 1)", 
          label = "Lag1", 
          header = FALSE, 
          type = "latex", 
          align = FALSE, 
