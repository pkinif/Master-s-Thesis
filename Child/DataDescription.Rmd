...
## Here I regress Y on X's
M1<-lm(TobinsQ~EnergyProductivity+CarbonProductivity+WaterProductivity+WasteProductivity+GreenReputation+SustainabilityPayLink+SustainableThemedCommitment+AuditScore+DebtRatio+NetMargin+log(Asset)+ROE,data=DB)
